...
- IK-005 is verified (`HttpOutboxPublisher`; `MINDVAULT_OUTBOX_HTTP_URL` + bearer token). SPACE-002 is in_progress (2026-08-22): SM/retry, self-approve, own-G5, broaden, and Space-scoped admit membership are tested; unified action envelope (IK-020) remains. Still unfinished ahead of vertical packs: SPACE-006 DocumentWorkspace rename, SPACE-003 reliable adapter effects (IK-006 verified), Trust Ledger (IK-020), and external executor isolation (AGENT-004).

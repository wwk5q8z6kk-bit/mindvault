...
impl MindVaultEngine {
    ...
    /// Result of executing a proposal action (create/update/delete node).
    /// Returned by [`execute_proposal_action`] so callers can build responses.
...
// ── Proposal execution types and helpers ──────────────────────────────────
